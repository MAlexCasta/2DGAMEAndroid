...
import com.example.reviv.game2d.framework.DinamicGameObject;
import com.example.reviv.game2d.framework.Game;
import com.example.reviv.game2d.framework.GameObject;
import com.example.reviv.game2d.framework.Input.TouchEvent;
import com.example.reviv.game2d.framework.Screen;
import com.example.reviv.game2d.framework.SpatialHashGrid;
import com.example.reviv.game2d.framework.gl.Camera2D;
import com.example.reviv.game2d.framework.gl.Texture;
...
import com.example.reviv.game2d.framework.math.OverlapTester;
...
public class TextureAtlasTest extends GLGame {
    ...
    public Screen getStartScreen(){return new TextureAtlasScreen(this);}
    ...
    class TextureAtlasScreen extends Screen
    {
        ...
        public TextureAtlasScreen(Game game)
        {
            ...
            cannon=new Cannon(WORLD_WIDTH/2,0,0.2f,0.2f);
            ball = new DinamicGameObject(0, 0, 0.2f, 0.2f);
